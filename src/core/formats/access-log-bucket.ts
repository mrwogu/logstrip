import { matchAccessLogLine } from './access-log-classifier.js';
 ...
 */
export function accessBucketPush(
  bucket: AccessBucket | null,
  line: string,
): {
  bucket: AccessBucket | null;
  ejected: string | null;
...
export function flushAccessBucket(bucket: AccessBucket | null): string | null {
