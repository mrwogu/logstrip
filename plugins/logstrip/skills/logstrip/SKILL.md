---
name: logstrip
description: Compress noisy CI, build, runtime, and test logs with the LogStrip CLI. Use when the user asks to trim, compress, reduce, or prepare logs for LLM analysis.
user-invocable: true
---
