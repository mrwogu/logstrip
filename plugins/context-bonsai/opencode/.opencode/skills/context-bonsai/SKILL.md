...
ContextBonsai removes repeated low-signal lines, masks common identifiers, collapses internal stack frames, and reports token savings so OpenCode spends context on diagnostics instead of noise.
